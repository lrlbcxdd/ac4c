...
model_checkpoint_1024 = "/mnt/sdb/home/zyx/SpliceBERT-main/models/SpliceBERT.1024nt"
model_checkpoint_510 = "/mnt/sdb/home/zyx/SpliceBERT-main/models/SpliceBERT-human.510nt"
...
class BertClassificationModel(nn.Module):
    ...
    def forward(self, batch_sentences):  # [batch_size,1]
        ...
        input_ids, token_type_ids, attention_mask = token_seq['input_ids'], token_seq['token_type_ids'], token_seq[
            'attention_mask']
        representation_1 = \
        self.bert_510(input_ids=input_ids.to(self.device), token_type_ids=token_type_ids.to(self.device),
        ...
        input_ids, token_type_ids, attention_mask = token_seq['input_ids'], token_seq['token_type_ids'], token_seq[
            'attention_mask']
        representation_2 = \
        self.bert_1024(input_ids=input_ids.to(self.device), token_type_ids=token_type_ids.to(self.device),
                       attention_mask=attention_mask.to(self.device))['last_hidden_state']
    ...
    for index in range(11):
        ...
        for epoch in range(epoch_num):
            ...
            if valid_acc > best_acc:
                ...
                filename = '{}, {}[{:.4f}].pt'.format(f'model{model_type}' + ', epoch[{}]'.format(epoch + 1), 'ACC',
                                                      test_performance[0])
